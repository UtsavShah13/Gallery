...
struct ServerConstant {
    ...
    static let domain = "http:52.15.125.158/api/v1/"
//    "http://ec2-18-220-48-162.us-east-2.compute.amazonaws.com/api/v1/"
    static let imageDomain = ""
    static let socketIODomain = "http://52.15.125.158/"
    
    struct WebService {
        
        static let version = "v1"
        static let apiVersion = "1"
        static let apiURL = "\(ServerConstant.domain)"
        ...
        struct UpdateFCMToken {
            static let name = "tokenupdate.json"
            struct Request {
        ...
        //MARK:- Setup API name with its actual key for used in servercommunication manager
        
//        EG: -
        
//        struct SignInWithEmail {
//            static let name = "account/auth/authentication"
//        }
    ...
    struct WebPage {
        ...
        static let webURL = "\(ServerConstant.domain)m/"
        
        struct Links {
            static let help = "\(ServerConstant.WebPage.webURL)help"
            static let legal = "\(ServerConstant.WebPage.webURL)legal"
            static let feedback = "\(ServerConstant.WebPage.webURL)feedback"
            static let termsAndCondition = "\(ServerConstant.WebPage.webURL)terms_and_condition"
            static let contentPolicy = "\(ServerConstant.WebPage.webURL)content_policy"
            static let privacy = "\(ServerConstant.WebPage.webURL)privacy"
        }
